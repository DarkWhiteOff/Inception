...
if [ ! -d "$DATADIR/mysql" ]; then
    ...
    echo ">> Lancement de MariaDB en arrière-plan pour configuration initiale..."
...
EOF
    ...
    echo ">> Datadir déjà initialisé, pas de reconfiguration."
fi

echo ">> Lancement définitif de MariaDB au premier plan..."
